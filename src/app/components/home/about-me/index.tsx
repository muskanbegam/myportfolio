          ...
          <div className="container">
            ...
            <div className="pt-10 xl:pt-16 flex gap-10 items-center justify-between">
              ...
              <div className="w-full lg:max-w-2xl flex-1">
                <p>
                  I build websites that feel less “corporate template” and more this is so us. I like clean design, smooth interactions, and code that just works without drama. Still learning, always improving, slightly obsessed with making things look aesthetic and function perfectly. If it’s online, I probably want to build it better.
                </p>
